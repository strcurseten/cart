            ...
            <div class="px-3 py-2 bg-dark text-white">
                <div class="container">
                    ...
                    <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                        <li>
                        <a href="products-list.php" class="nav-link text-white">
                            <div class="fs-4 mb-3">
                        ...
                        <li>
                        <a href="shopping-cart.php" class="nav-link text-secondary">
                        <div class="fs-4 mb-3">
...
<body>
    <div class="container-fluid" id="bag">
        ...
        <h5 class="card-header">Shopping Bag</h5>
            <div class="card-body">
                <h5 class="card-title"><?php echo $customer->getName() ?>, your bag is currently empty.</h5>
                <p class="card-text">Check out our products list and see what you'd like!</p>
